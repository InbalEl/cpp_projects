...
// constructor
Shape::Shape(const std::string& str, int newx, int newy)
{
   moveTo(newx, newy);
   m_str = str;
    std::cout << "The current shape is: " << m_str << std::endl;
}
...
// constructor
Rectangle::Rectangle(const std::string& str,int newx, int newy, int newwidth, int newheight): 
                    Shape(str, newx, newy) 
{
    setWidth(newwidth);
    setHeight(newheight);
...
// constructor
Circle::Circle(const std::string& str, int newx, int newy, int newradius): Shape(str, newx, newy)
{
   setRadius(newradius);
}
